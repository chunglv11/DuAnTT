...
using BanDochoi.Web.Areas.Admin.Models.Models;
using BanDochoi.Web.Areas.Admin.Models.Role;
...
namespace BanDochoi.Web.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, BanDoChoiDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
